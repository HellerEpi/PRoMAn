...
## Current Status
PRoMAn is under development, and the current release (0.6.0.9000) is a test release.  Major components are functioning, but there are some minor bugs and aesthetic issues.

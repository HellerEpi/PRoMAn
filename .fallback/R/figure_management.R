...
#' @export
theme_academic <- function(base_size = 11, grid = TRUE) {
  ...
  theme <- ggplot2::theme_minimal(base_size = base_size) +
    ggplot2::theme(
      ...
      # Legend
      legend.background = ggplot2::element_rect(fill = "#fffff8", color = NA),
      legend.key = ggplot2::element_rect(fill = "#fffff8", color = NA),
